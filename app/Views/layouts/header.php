...
<head>
    ...
    <link rel="stylesheet" href="<?= Configuration::$ROOT; ?>public/css/sidebar-and-template.css">
    <link rel="stylesheet" href="<?= Configuration::$ROOT; ?>public/css/style.css">
    <script src="https://code.jquery.com/jquery-3.7.0.min.js" integrity="sha256-2Pmvv0kuTBOenSvLm6bvfBSSHrUJ+3A7x6P5Ebd07/g=" crossorigin="anonymous"></script>
    <script src="<?= Configuration::$ROOT; ?>public/js/sidebar.js"></script>
